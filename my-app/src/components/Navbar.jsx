...
1. GET /users/profile - Fetches user profile data
2. POST /users/logout - Logs out user and blacklists token

📋 FRONTEND ROUTES NEEDED:
1. /login - Login page
2. /profile - User profile page  
3. /my-articles - User's articles page
4. /create-post - Create new post page
5. / - Home page

📋 AUTHENTICATION FLOW:
1. Token stored in localStorage as 'token'
2. Sent as Bearer token in Authorization header
3. On 401 errors: Clear storage and redirect to login
...
2. Verify token format in backend (should be Bearer token)
3. Check if authMiddleware is working correctly
4. Ensure token hasn't expired
5. Make sure VITE_BASE_URL points to correct backend URL

📋 NEXT STEPS:
1. Test logout function (console.log should work now)
2. Create the missing route pages (/profile, /my-articles, etc.)
3. Implement search functionality
4. Add theme switching
5. Add proper error notifications/toasts
*/